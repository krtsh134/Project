...
class TestBusinessLogicLayer(unittest.TestCase):
    def test_calculate_nutritional_value_success(self):
        ...
        product_data = {
            "apple": (52, 0.3, 0.2, 14),  # (kcal, proteins, fats, carbs)
        ...
        expected = {
            "kilocalories": 150 * 52 / 100 + 100 * 96 / 100,  # 78 + 96 = 174
            "proteins": round(150 * 0.3 / 100 + 100 * 1.3 / 100, 2),  # 0.45 + 1.3 = 1.75
            "fats": round(150 * 0.2 / 100 + 100 * 0.3 / 100, 2),  # 0.3 + 0.3 = 0.6
            "carbohydrates": round(150 * 14 / 100 + 100 * 27 / 100, 2)  # 21 + 27 = 48
        }

...
train_plans = [
    (16, 20, 10.0, 20.0, "Train_1", "Female",
     "разминка, пробежка 20 минут, приседания 3х15, отжимания 3х15,подтягивания (или тяги к поясу) 3х10, заминка."),
    (16, 20, 10.0, 20.0, "Train_2", "Female",
     "разминка, высокоинтенсивная интервальная тренировка (HIIT) 15 минут, берпи 3х12, планка 3х30сек, заминка."),
    (16, 20, 10.0, 20.0, "Train_1", "Male",
     "разминка, велотренажер 25 минут, выпады 3х15 на каждую ногу, подъёмы на икры 3х10, заминка."),
    (16, 20, 10.0, 20.0, "Train_2", "Male",
     "разминка, пробежка 20 минут, приседания 3х15, отжимания 3х15,подтягивания (или тяги к поясу) 3х10, заминка."),
    (16, 20, 20.1, 25.0, "Train_1", "Female",
     "разминка, пробежка 25 минут, приседания 3х10 с гантелями (2-3 кг), отжимания 3х12, выпады 3х12 на каждую ногу, заминка."),
    (16, 20, 20.1, 25.0, "Train_2", "Female",
     "разминка, высокоинтенсивная интервальная тренировка 20 минут, берпи 3х10, прыжковые приседания 3х15, альпинист 3х15, заминка."),
    (16, 20, 20.1, 25.0, "Train_1", "Male",
     "разминка, пробежка 25 минут, приседания 3х10 с гантелями (2-3 кг), отжимания 3х12, выпады 3х12 на каждую ногу, заминка."),
    (16, 20, 20.1, 25.0, "Train_2", "Male",
     "разминка, эллиптический тренажер 30 минут, приседания 3х15, отжимания 3х10, заминка."),
    (16, 20, 25.1, 35.0, "Train_1", "Female",
     "разминка, 30 минут быстрой ходьбы, приседания 3х10, отжимания у стены 3х10, поворот корпуса  3х15, заминка."),
    (16, 20, 25.1, 35.0, "Train_2", "Female",
     "разминка, езда на велосипеде 25 минут, приседания 3х12, подъём ног 3х10, заминка."),
    (16, 20, 25.1, 35.0, "Train_1", "Male",
     "разминка, 30 минут быстрой ходьбы, приседания 3х10, отжимания у стены 3х10, поворот корпуса  3х15, заминка."),
    (16, 20, 25.1, 35.0, "Train_2", "Male",
     "разминка, 20 минут быстрой ходьбы, приседаний на стуле 3х10, 3х15 шагов на месте, заминка."),

    (21, 25, 10.0, 20.0, "Train_1", "Female",
     "разминка, пробежка 20 минут, приседания 3х15, отжимания на брусьях 3х15, подтягивания (или тяга к поясу) 3х15, заминка."),
    (21, 25, 10.0, 20.0, "Train_2", "Female",
     "разминка, высокоинтенсивная интервальная тренировка 15 минут (берпи, альпинисты, прыжки), 3х30сек в планке, 3х15 прыжков в приседе, заминка."),
    (21, 25, 10.0, 20.0, "Train_1", "Male",
     "разминка, 25-минутная езда на велосипеде, выпады 3х15 на каждую ногу, подъёмы на икры 3х10, скручивания на пресс 3х15, заминка."),
    (21, 25, 10.0, 20.0, "Train_2", "Male",
     "разминка, пробежка 20 минут, приседания 3х15, отжимания на брусьях 3х15, подтягивания (или тяга к поясу) 3х15, заминка."),
    (21, 25, 20.1, 25.0, "Train_1", "Female",
     "разминка, 25-минутный интервальный бег, приседания с гантелями (5 кг) 3х12, отжимания 3х10, 3х10 подтягиваний, заминка."),
    (21, 25, 20.1, 25.0, "Train_2", "Female",
     "разминка, 20-минутная высокоинтенсивная интервальная тренировка (берпи, прыжки на скакалке, альпинист), 3х15 махов гирей, 3 подхода по 20 русских скруток, заминка."),
    (21, 25, 20.1, 25.0, "Train_1", "Male",
     "разминка, 25-минутный интервальный бег, приседания с гантелями (5 кг) 3х12, отжимания 3х10, 3х10 подтягиваний, заминка."),
    (21, 25, 20.1, 25.0, "Train_2", "Male",
     "разминка, 30 минут на гребном тренажере, приседания 3х15, отжимания 3х10, выпады 3х15, заминка."),
    (21, 25, 25.1, 35.0, "Train_1", "Female",
     "разминка, 30 минут быстрой ходьбы, приседания 3х10, отжимания на брусьях 3х10, 3х15 поворотов корпуса, заминка."),
    (21, 25, 25.1, 35.0, "Train_2", "Female",
     "разминка, 25-минутная езда на велосипеде, приседания 3х12, подъёмы ног 3х10, скручивания сидя 3х15, заминка."),
    (21, 25, 25.1, 35.0, "Train_1", "Male",
     "разминка, 30 минут быстрой ходьбы, приседания 3х10, отжимания на брусьях 3х10, 3х15 поворотов корпуса, заминка."),
    (21, 25, 25.1, 35.0, "Train_2", "Male",
     "разминка, 20 минут быстрой ходьбы, приседания на стуле 3х10, шаги на месте 3х15, круговые движения руками 3х10, заминка."),

    (26, 30, 10.0, 20.0, "Train_1", "Female",
     "разминка 5 минут, бег трусцой 25 минут, приседания 3х15, отжимания на брусьях 3х12, тяга гантелей в наклоне 3х10 на каждую руку (гантели по 5–8 кг), планка 3х30сек, заминка 5 минут."),
    (26, 30, 10.0, 20.0, "Train_2", "Female",
     "разминка, высокоинтенсивная интервальная тренировка 20 минут (30 секунд упражнение и 30 секунд отдыха): берпи, альпинисты, прыжки на месте; выпады 3х10 на каждую ногу, скручивания 3х15 на каждую сторону, подъёмы ног 3х15, заминка."),
    (26, 30, 10.0, 20.0, "Train_1", "Male",
     "разминка 5 минут, бег трусцой 25 минут, приседания 3х15, отжимания на брусьях 3х12, тяга гантелей в наклоне 3х10 на каждую руку (гантели по 5–8 кг), планка 3х30сек, заминка 5 минут."),
    (26, 30, 10.0, 20.0, "Train_2", "Male",
     "разминка, велотренажёр 30 минут, приседания 3х15, отжимания 3хМаксимальное кол-во повторений, боковая планка 3х30сек на каждую сторону, ягодичный мостик 3х15, заминка."),
    (26, 30, 20.1, 25.0, "Train_1", "Female",
     "разминка, бег трусцой 30 минут, приседания с гантелью или гирей 3х10, отжимания 3х12, тяга гантели в наклоне 3х10 на каждую руку (гантели 8–12 кг), планка 3х45сек, заминка."),
    (26, 30, 20.1, 25.0, "Train_2", "Female",
     "разминка, круговая тренировка 25 минут (берпи, прыжки в приседе, высокие колени), тяга гантелей 3х10 (гантели 5–8 кг), скручивания 3х15 на каждую сторону, боковая планка 3х45 каждую сторону, заминка."),
    (26, 30, 20.1, 25.0, "Train_1", "Male",
     "разминка, бег трусцой 30 минут, приседания с гантелью или гирей 3х10, отжимания 3х12, тяга гантели в наклоне 3х10 на каждую руку (гантели 8–12 кг), планка 3х45сек, заминка."),
    (26, 30, 20.1, 25.0, "Train_2", "Male",
     "разминка, занятия на эллиптическом тренажере 35 минут, прыжки со скакалкой 3х100, отжимания на наклонной скамье 3х12, сгибания рук с гантелями 3х12 (гантели 5–8 кг), заминка."),
    (26, 30, 25.1, 35.0, "Train_1", "Female",
     "разминка, быстрая ходьба 35 минут, приседания на стуле 3х12, отжимания от стены 3х12, повороты корпуса 3х15 на каждую сторону, подъёмы рук 3х15, заминка."),
    (26, 30, 25.1, 35.0, "Train_2", "Female",
     "разминка, велотренажёр 30 минут, модифицированные приседания 3х12, подъёмы ног 3х15, скручивания корпуса сидя 3х15 на каждую сторону, круговые движения руками 3х15 вперёд, 3х15 назад, заминка."),
    (26, 30, 25.1, 35.0, "Train_1", "Male",
     "разминка, быстрая ходьба 35 минут, приседания на стуле 3х12, отжимания от стены 3х12, повороты корпуса 3х15 на каждую сторону, подъёмы рук 3х15, заминка."),
    (26, 30, 25.1, 35.0, "Train_2", "Male",
     "разминка, аквааэробика 30 минут, ходьба на месте 3х60сек, движения рук в воде 3х60сек, движения ног в воде 3х60сек, заминка"),

    (31, 35, 10.0, 20.0, "Train_1", "Female",
     "Разминка 5 минут, Кардио 25 минут, Приседания 3х15, Отжимания на наклонной скамье 3х12, Тяга гантелей в наклоне 3х12, Планка 3х45сек, статическая растяжка 5 минут"),
    (31, 35, 10.0, 20.0, "Train_2", "Female",
     "Разминка 5 минут, Круговая тренировка 20 минут (45 секунд упражнения и отдых 15 секунд) 3 раза: берпи, альпинисты, выпрыгивания, выпады с чередованием ног; скручивания 3х20, планка 3х30сек, растяжка 5 минут"),
    (31, 35, 10.0, 20.0, "Train_1", "Male",
     "Разминка 5 минут, Кардио 25 минут, Приседания 3х15, Отжимания на наклонной скамье 3х12, Тяга гантелей в наклоне 3х12, Планка 3х45сек, статическая растяжка 5 минут"),
    (31, 35, 10.0, 20.0, "Train_2", "Male", "Разминка 5 минут, йога 45 минут, заминка 5 минут"),
    (31, 35, 20.1, 25.0, "Train_1", "Female",
     "разминка 5 минут, кардио 30 имнут, Приседания с гантелями 3х12, Отжимания 3хМаксимальное кол-во повторений, Жим гантелей лёжа 3х10, Тяга гантелей в наклоне 3х10, Планка 3х60сек, растяжка 5 минут"),
    (31, 35, 20.1, 25.0, "Train_2", "Female",
     "разминка 5 минут, круговая тренировка 25 мин: берпи, размахивания гантелями, степ, выпады; русские скрутки 3х25, планка 3х45сек, статическая растяжка 5 минут"),
    (31, 35, 20.1, 25.0, "Train_1", "Male",
     "разминка 5 минут, кардио 30 имнут, Приседания с гантелями 3х12, Отжимания 3хМаксимальное кол-во повторений, Жим гантелей лёжа 3х10, Тяга гантелей в наклоне 3х10, Планка 3х60сек, растяжка 5 минут"),
    (31, 35, 20.1, 25.0, "Train_2", "Male", "разминка 5 минут, приседания, становая тяга, заминка 5 минут"),
    (31, 35, 25.1, 35.0, "Train_1", "Female",
     "Разминка 5 минут, кардио 35 мин, Приседания на стуле 3х15, Отжимания от стены 3х12, Подъём гантелей на бицепс 3х15, Разгибание трицепсов с гантелями 3х15, планка 3х30сек, заминка"),
    (31, 35, 25.1, 35.0, "Train_2", "Female", "Разминка 5 минут, акваэробика 45 мин, заминка 5 минут"),
    (31, 35, 25.1, 35.0, "Train_1", "Male",
     "Разминка 5 минут, кардио 35 мин, Приседания на стуле 3х15, Отжимания от стены 3х12, Подъём гантелей на бицепс 3х15, Разгибание трицепсов с гантелями 3х15, планка 3х30сек, заминка"),
    (31, 35, 25.1, 35.0, "Train_2", "Male",
     "Разминка 5 минут, Круговая тренировка 30 минут: подтягивания, подъем ног лежа на боку, скручивания туловища;  заминка"),

    (36, 40, 10.0, 20.0, "Train_1", "Female",
     "Разминка 7 минут, кардио 30 минут, Приседания 3х12, отжимания 3хМаксимальное кол-во, тяга в наклоне с гантелями 3х12, жим над головой 3х12, планка минуту, заминка 7 минут"),
    (36, 40, 10.0, 20.0, "Train_2", "Female",
     "Разминка 7 минут, Круговая тренировка (45 секунд упражнения, 15 секунд отдыха): берпи, скалолаз, выпрыгивания, выпады; планка 3х30сек, заминка 5 минут"),
    (36, 40, 10.0, 20.0, "Train_1", "Male",
     "Разминка 7 минут, кардио 30 минут, Приседания 3х12, отжимания 3хМаксимальное кол-во, тяга в наклоне с гантелями 3х12, жим над головой 3х12, планка минуту, заминка 7 минут"),
    (36, 40, 10.0, 20.0, "Train_2", "Male", "Разминка 5 минут, Йога 45 минут, заминка 5 минут"),
    (36, 40, 20.1, 25.0, "Train_1", "Female",
     "Разминка 5 минут, кардио 30 минут, отжимания 3хМаксимальное кол-во, приседания 3х12, скручивания на пресс 3х10, румынская тяга (8кг) 3х10, планка 60 секунд, заминка 5 минут"),
    (36, 40, 20.1, 25.0, "Train_2", "Female",
     "Разминка 5 минут, круговая тренировка 25 минут (45 секунд упражнения, 15 отдых): берпи, скалолаз, выпрыгивания; заминка 5 минут"),
    (36, 40, 20.1, 25.0, "Train_1", "Male",
     "Разминка 5 минут, кардио 30 минут, отжимания 3хМаксимальное кол-во, приседания 3х12, скручивания на пресс 3х10, румынская тяга (8кг) 3х10, планка 60 секунд, заминка 5 минут"),
    ...
    (36, 40, 25.1, 35.0, "Train_2", "Female",
     "Разминка 5 минут, круговая тренировка 20 минут (45 секунд упражнения, 15 отдых): берпи, скалолаз, выпрыгивания, заминка 5 минут"),
    ...
    (41, 45, 10.0, 20.0, "Train_1", "Female",
     "Разминка 7 минут, кардио 30 минут, приседания 3х12, отжимания 3хМаксимальное кол-во, Тяга гантелей в наклоне 3х12 на каждую руку, планка 3х45сек, заминка 5 минут"),
    (41, 45, 10.0, 20.0, "Train_2", "Female",
     "Разминка 5 минут, Круговая тренировка 20 минут (45 секунд упражнения, 15 секунд отдыха): берпи, скалолаз, выпрыгивания, выпады; заминка 5 минут"),
    (41, 45, 10.0, 20.0, "Train_1", "Male",
     "Разминка 7 минут, кардио 30 минут, приседания 3х12, отжимания 3хМаксимальное кол-во, Тяга гантелей в наклоне 3х12 на каждую руку, планка 3х45сек, заминка 5 минут"),
    (41, 45, 10.0, 20.0, "Train_2", "Male", "Разминка 5 минут, йога 60 минут, заминка 5 минут"),
    (41, 45, 20.1, 25.0, "Train_1", "Female",
     "Разминка 5 минут, кардио 30 минут, приседания 3х15, отжимания 3хМаксимальное кол-во, Тяга гантелей в наклоне 3х15 на каждую руку, планка 3х45сек, заминка 5 минут"),
    (41, 45, 20.1, 25.0, "Train_2", "Female",
     "Разминка 5 минут, Круговая тренировка 25 минут (45 секунд упражнения, 15 секунд отдыха): берпи, скалолаз, выпрыгивания, выпады; заминка 5 минут"),
    (41, 45, 20.1, 25.0, "Train_1", "Male",
     "Разминка 5 минут, кардио 30 минут, приседания 3х15, отжимания 3хМаксимальное кол-во, Тяга гантелей в наклоне 3х15 на каждую руку, планка 3х45сек, заминка 5 минут"),
    (41, 45, 20.1, 25.0, "Train_2", "Male", "Разминка 5 минут, йога 70 минут, заминка 5 минут"),
    (41, 45, 25.1, 35.0, "Train_1", "Female",
     "Разминка 7 минут, кадио 35, приседания у стула 3х15, отжимания от стены 3х12, Сгибания рук с гантелями 3х15, Разгибания рук с гантелями 3х12, планка 3х40сек заминка 5 минут"),
    (41, 45, 25.1, 35.0, "Train_2", "Female", "Разминка 5 минут, аквааэробика 40 минут, заминка 5 минут"),
    (41, 45, 25.1, 35.0, "Train_1", "Male",
     "Разминка 7 минут, кадио 35, приседания у стула 3х15, отжимания от стены 3х12, Сгибания рук с гантелями 3х15, Разгибания рук с гантелями 3х12, планка 3х40сек заминка 5 минут"),
    (41, 45, 25.1, 35.0, "Train_2", "Male", "Разминка 5 минут, йога 50 минут, растяжка в воде 5 минут"),

    (46, 50, 10.0, 20.0, "Train_1", "Female",
     "Разминка 10 минут, ходьба 25 минут, приседания у стуал 3х12, отжимания у стены 3х10, Подъемы рук с гантелями 3х12, Подъемы ног лежа 3х10, планка 3х40, упражнение на балланс по 30 секунд, заминка 7 минут"),
    (46, 50, 10.0, 20.0, "Train_2", "Female", "Разминка 7 минут, йога 60 минут, заминка 7 минут"),
    (46, 50, 10.0, 20.0, "Train_1", "Male",
     "Разминка 10 минут, ходьба 25 минут, приседания у стуал 3х12, отжимания у стены 3х10, Подъемы рук с гантелями 3х12, Подъемы ног лежа 3х10, планка 3х40, упражнение на балланс по 30 секунд, заминка 7 минут"),
    (46, 50, 10.0, 20.0, "Train_2", "Male",
     "Разминка 7 минут, круговая трениовка 20 минут (30 секунд упражнение, 15 секунд отдых): ходьба на месте, медленные приседания у стуал, подъемы ног и руук лежа, планка, растяжка, заминка 7 минут"),
    (46, 50, 20.1, 25.0, "Train_1", "Female",
     "Разминка 10 минут, ходьба 30 минут, приседания у стуал 3х15, отжимания у стены 3х12, Подъемы рук с гантелями 3х15, Подъемы ног лежа 3х12, планка 3х45, упражнение на балланс по 40 секунд, заминка 5 минут"),
    (46, 50, 20.1, 25.0, "Train_2", "Female", "Разминка 7 минут, акваэробика 60 минут, заминка 5 минут"),
    (46, 50, 20.1, 25.0, "Train_1", "Male",
     "Разминка 10 минут, ходьба 30 минут, приседания у стуал 3х15, отжимания у стены 3х12, Подъемы рук с гантелями 3х15, Подъемы ног лежа 3х12, планка 3х45, упражнение на балланс по 40 секунд, заминка 5 минут"),
    (46, 50, 20.1, 25.0, "Train_2", "Male",
     "Разминка 7 минут, круговая трениовка 25 минут (30 секунд упражнение, 15 секунд отдых): ходьба на месте, медленные приседания у стуал, подъемы ног и руук лежа, планка, растяжка, заминка 5 минут"),
    (46, 50, 25.1, 35.0, "Train_1", "Female",
     "Разминка 7 минут, ходьба 30 минут, приседания у стуал 3х10, отжимания от стены 3х10, подъемы рук с легкими гантелями 3х10, подъемы туловища 3х10, заминка 8 минут"),
    (46, 50, 25.1, 35.0, "Train_2", "Female", "Разминка 5 минут в воде, аквааэробика 45 минут, заминка 5 минут"),
    (46, 50, 25.1, 35.0, "Train_1", "Male",
     "Разминка 7 минут, ходьба 30 минут, приседания у стуал 3х10, отжимания от стены 3х10, подъемы рук с легкими гантелями 3х10, подъемы туловища 3х10, заминка 8 минут"),
    (46, 50, 25.1, 35.0, "Train_2", "Male", "Разминка 5 минут, йога, упражнения на гибкость 60 минут, заминка 5 минут"),

    (51, 55, 10.0, 20.0, "Train_1", "Female",
     "Разминка 10 минут, скандинавская ходьба 25 минут, приседания у стула 3х8, отжимания у стены 3х8, Подъемы рук с легкими гантелями 3х8, Подъемы ног лежа на спине 3х8, планка 3х30 сек, Упражнения на баланс, заминка 10 минут"),
    (51, 55, 10.0, 20.0, "Train_2", "Female",
     "Разминка 7 минут, йога 45 минут, упражнения на гибкость, заминка 7 минут"),
    (51, 55, 10.0, 20.0, "Train_1", "Male",
     "Разминка 10 минут, скандинавская ходьба 25 минут, приседания у стула 3х8, отжимания у стены 3х8, Подъемы рук с легкими гантелями 3х8, Подъемы ног лежа на спине 3х8, планка 3х30 сек, Упражнения на баланс, заминка 10 минут"),
    (51, 55, 10.0, 20.0, "Train_2", "Male",
     "Разминка 5 минут, круговая тренировка 20 минут (упражнение 30 секунд, отдых 15 секунд): Ходьба на месте с высоким подниманием коленей, Медленные приседания у стула, Подъемы рук, Подъемы ног лежа на спине, Упражнения на растяжку, заминка 5 минут"),
    (51, 55, 20.1, 25.0, "Train_1", "Female",
     "Разминка 10 минут, скандинавская ходьба 30 минут, приседания у стула 3х10, отжимания у стены 3х10, Подъемы рук с легкими гантелями 3х10, Подъемы ног лежа на спине 3х8, планка 3х25 сек, Упражнения на баланс, заминка 10 минут"),
    (51, 55, 20.1, 25.0, "Train_2", "Female",
     "Разминка 7 минут, йога 60 минут, упражнения на гибкость, заминка 7 минут"),
    (51, 55, 20.1, 25.0, "Train_1", "Male",
     "Разминка 10 минут, скандинавская ходьба 30 минут, приседания у стула 3х10, отжимания у стены 3х10, Подъемы рук с легкими гантелями 3х10, Подъемы ног лежа на спине 3х8, планка 3х25 сек, Упражнения на баланс, заминка 10 минут"),
    (51, 55, 20.1, 25.0, "Train_2", "Male",
     "Разминка 5 минут, круговая тренировка 30 минут (упражнение 30 секунд, отдых 15 секунд): Ходьба на месте с высоким подниманием коленей, Медленные приседания у стула, Подъемы рук, Подъемы ног лежа на спине, Упражнения на растяжку, заминка 5 минут"),
    (51, 55, 25.1, 35.0, "Train_1", "Female",
     "Разминка 10 минут, ходьба 30 минут, приседания у стула 3х8, подъемы рук 3х10, подъемы ног 3х10, заминка 10 минут"),
    (51, 55, 25.1, 35.0, "Train_2", "Female",
     "Разминка в воде 7 минут, аквааэробика 40 минут низкая интенсивность, заминка в воде 7 минут"),
    (51, 55, 25.1, 35.0, "Train_1", "Male",
     "Разминка 10 минут, ходьба 30 минут, приседания у стула 3х8, подъемы рук 3х10, подъемы ног 3х10, заминка 10 минут"),
    (51, 55, 25.1, 35.0, "Train_2", "Male",
     "Разминка 7 минут, йога 45 минут - базовые упражнения на гибкость и укрепление мышц, заминка 5 минут - "
